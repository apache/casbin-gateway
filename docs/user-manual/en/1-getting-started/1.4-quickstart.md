...
No API key, because the agent is on a ChatGPT or Claude subscription? Set **Authentication** to **the caller's own login** instead — [3.3](../3-providers/3.3-caller-login.md).
