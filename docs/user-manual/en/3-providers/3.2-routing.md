...
3. **Translated**, if the provider speaks a different API.
4. **Relayed**, with the provider's key.
5. **Recorded**, to the depth `llmRecordMode` says ([4.2](../4-governance/4.2-llm-records.md)).
